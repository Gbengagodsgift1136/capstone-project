...
//const API_URL = BASE_URL +'/movie/upcoming?language=en-US&page=1&sort_by=upcoming.desc&' + API_KEY; 
const API_URL = BASE_URL + '/movie/top_rated?language=en-US&page=1&sort_by=top_rated.desc&' + API_KEY; 
